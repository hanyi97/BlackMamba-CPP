...
/**
 * Initialise help menu screen objects
 */
void Help::init()
{
        ...
        switch (event.type)
        {
            ...
            case sf::Event::MouseButtonPressed:
                if (event.mouseButton.button == sf::Mouse::Left)
                {
                    ...
                    {
                        if (event.mouseButton.y >= 536 and event.mouseButton.y <= 591) startButtonPressed = true;
                    }
                }
                break;
